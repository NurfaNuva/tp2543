...
if (isset($_POST['create'])) {
  ...
  try {
    ...
    $stmt = $conn->prepare("INSERT INTO tbl_customers_a173823_pt2(fld_customer_name, fld_customer_phone) VALUES(:name, :phone)");
...
if (isset($_POST['update'])) {
  ...
  try {
    ...
    $stmt = $conn->prepare("UPDATE tbl_customers_a173823_pt2 SET fld_customer_num = :oldcid, 
