  			...
  			<div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
  				...
  				<form action="products.php" method="post" class="form-horizontal">
  					...
  					<div class="form-group">
  						...
  						<div class="col-sm-9">
  							<input name="pid" type="text" class="form-control" id="productid" placeholder="Product ID" value="<?php if(isset($_GET['edit'])) echo 'M'.$editrow['fld_product_num']; ?>" readonly>
  						</div>
  					</div>
  					<!-- Name -->
  					<div class="form-group">
  					...
  					<div class="form-group">
  						...
  						<div class="col-sm-9">
  							<input name="price" type="number" class="form-control" id="productprice" placeholder="Product Price" min="1.00" max="1000000.00" step="0.10" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_product_price']; ?>" required>
  						</div>
  					</div>
  					<!-- Brand -->
  					<div class="form-group">
  					...
  					<!-- Warranty -->
  					<div class="form-group">
  						<label for="productwty" class="col-sm-3 control-label">Manufacturing Year</label>
  						<div class="col-sm-9">
