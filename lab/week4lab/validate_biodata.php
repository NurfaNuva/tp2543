...
if (isset($_POST['biodata_form'])) {
  ...
  {
    $msg .= "Error: Please choose sex.<br>";
    $count_error++;
  }
  ...
  {
    $msg .= "Error: Please insert dob.<br>";
    $count_error++;
  }
  ...
  {
    $msg .= "Error: Please choose a color.<br>";
    $count_error++;
  }
  ...
  {
    $msg .= "Error: Please insert facebook/twitter/instagram.<br>";
    $count_error++;
  }
  ...
  {
    $msg .= "Error: Please choose a university.<br>";
    $count_error++;
  }
